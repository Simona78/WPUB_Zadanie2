...
<xsl:template name="book.titlepage.before.recto">
	<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" text-align="center" font-size="14pt" border-bottom-width="0.5pt" border-bottom-style="solid" font-family="sans-serif" text-transform="uppercase">
      <xsl:value-of select="/book/bookinfo//affiliation/orgname"/>
    </fo:block>
	<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" space-before="6pt" space-after="6pt" text-align="center" font-size="14pt" font-family="sans-serif" text-transform="uppercase">
      <xsl:value-of select="/book/bookinfo//affiliation/orgdiv[@role='fakulta']"/>
    </fo:block>
</xsl:template>

<xsl:template name="book.titlepage.before.verso">
	<fo:block-container xmlns:fo="http://www.w3.org/1999/XSL/Format" absolute-position="absolute" left="0pt" top="17cm">
      <fo:block text-align="left" font-family="sans-serif" font-size="14pt">
		Študijný program: <xsl:value-of select="/book/bookinfo//affiliation/orgdiv[@role='program']"/>
       </fo:block>
	   <fo:block text-align="left" font-family="sans-serif" font-size="14pt">
		Študijný odbor: <xsl:value-of select="/book/bookinfo//affiliation/orgdiv[@role='odbor']"/>
       </fo:block>
	   <fo:block text-align="left" font-family="sans-serif" font-size="14pt">
		Školiace pracovisko: <xsl:value-of select="/book/bookinfo//affiliation/orgdiv[@role='pracovisko']"/>
       </fo:block>
	   <fo:block text-align="left" font-family="sans-serif" font-size="14pt">
		Vedúci práce: <xsl:value-of select="/book/bookinfo/othername[@role='vedouci']"/>
       </fo:block>
       <fo:block text-align="left" font-family="sans-serif" space-before="20pt" top="28cm">
		<xsl:value-of select="/book/bookinfo/pubdate"/>
       </fo:block>
	   <fo:block text-align="left" font-family="sans-serif" text-transform="uppercase">
		<xsl:apply-templates select="/book/bookinfo/author" mode="book.titlepage.recto.mode"/>
		</fo:block>
    </fo:block-container>
</xsl:template>
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" font-size="20pt" font-weight="normal" font-family="{$title.fontset}" space-before="7cm" text-transform="uppercase">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" font-size="14pt" font-weight="normal" space-before="1cm" font-family="{$title.fontset}" text-transform="uppercase">
